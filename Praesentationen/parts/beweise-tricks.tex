...
\begin{frame}[fragile]{Tricks: Beispiele und Gegenbeispiele}
    ...
    \begin{block}{Wann ein Beispiel \emph{nicht} ausreicht:}
        ...
        \glqq für Alle gilt\dots\grqq, \glqq es existiert kein\dots\grqq, es existiert genau ein\dots, etc. \\sind meist zu allgemeine Aussagen um sie mit endlich vielen Beispielen lückenlos zu beweisen.
    \end{block}
\end{frame}
