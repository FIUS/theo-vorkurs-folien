    ...
    \begin{itemize}
        ...
        \only<4>{
            ...
            \begin{exampleblock}{Beispiel}
                ...
                \vspace*{0.5cm}
                \textbf{Julian} ist ein Element aus der Menge der \textbf{Studenten}\\
                \textbf{Julian} $\in$ \textbf{Studenten}\\
                \vspace*{0.5cm}
        ...
        \item<6>
            ...
            \begin{exampleblock}{Beispiel}
                ...
                \vspace*{0.5cm}
                \{\textbf{Julian}\} ist eine Teilmenge der \textbf{Studenten}\\
                \{\textbf{Julian}\} $\subseteq$ \textbf{Studenten}
            \end{exampleblock}
