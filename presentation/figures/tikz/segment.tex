...
\pgfkeys{
    /sevenseg,
    default/.style = {shrink = 0.1, size = 1em, oncolor = red, offcolor = blue!70!black}
}
...
{%
    ...
    \def\sevensegarray{#2}%
    \begin{tikzpicture}[x=\sevensegSize,y=\sevensegSize]%
        % unten li
        ...
        \tikzstyle{segstyle} = [draw=\mycolor, line width = 0.15em,
        line cap = butt]
        % Horizontal oben
