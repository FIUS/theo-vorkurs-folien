...
\begin{frame}{Prädikate sind keine Aussagen!}
	\alert{Achtung:}
	\begin{itemize}[<+- | alert@+>]
		\item Ein Prädikat kann weder Wahr noch Falsch sein!
		\item Ein Prädikat wird zu einer Aussage wenn die Variable(n) eingesetzt werden
		\item Diese Aussage ist dann Wahr oder Falsch
	\end{itemize}
\end{frame}
...
\begin{frame}{Zurück zu den Zahlen}
	Definiere ein paar Prädikate in N und co
\end{frame}
