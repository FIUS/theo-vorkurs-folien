...
\begin{frame}{Denkpause}
	...
	\begin{block}{Normal}
		\begin{itemize}
			...
			\item $P_{\text{ZAHL}}\left(f_{\text{ON}}\left(X_2, Y_2\right)\right)$
			\item $P_{\text{ZAHL}}\left(f_{\text{ON}}\left(X_3, \sevenseg{{0,0,0,0,1,1,0,0,}}\right)\right) \land P_{\text{ZAHL}}\left(f_{\text{ON}}\left(X_3, \sevenseg{{1,0,0,1,0,0,0,}}\right)\right)$
