...
\begin{frame}<handout:0>{Lösungen}
  ...
  \begin{itemize}[<+- | alert@+>]
        ...
        \item $\emptyWord, 0, Mei, Totoro, MeiTotoro \in \{0, Mei, Totoro\}^{*}$
...
\begin{frame}[fragile]{Sprachen beschreiben}
    ...
    \begin{itemize}
        \item $L_1 = \{a^n \mid n\in\mathbb{N}\}$
        \item $L_2 = \{a^n \mid n \equiv 0 \pmod 2, n\in\mathbb{N}\}$
        \item $L_3 = \{uv \mid u\in\{a,b\}^\ast,\;v\in\{a\}\}$
        \item $L_4 = \{w \mid |w|_a = 3\}$
    \end{itemize}
    \end{exampleblock}
