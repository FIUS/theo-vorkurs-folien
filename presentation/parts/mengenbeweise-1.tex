...
\begin{frame}{einfacher Einstieg}
        ...
        \onslide{
            \begin{align*}
                x\in A \setminus (B \cup C) &\only<0-7>{\implies}\only<8->{\text{\alert<8>{$\iff$}}} x\in A \wedge \neg (x \in B \cup C)\\
                &\only<0-6>{\implies}\only<7->{\text{\alert<7>{$\iff$}}} x\in A \wedge \neg (x \in B \vee x \in C)\\
                &\only<0-5>{\implies}\only<6->{\text{\alert<6>{$\iff$}}} x \in A \wedge \neg (x \in B) \wedge \neg (x \in C)\\
                &\only<0-4>{\implies}\only<5->{\text{\alert<5>{$\iff$}}} x \in A \wedge \neg (x \in B) \wedge x \in A \wedge \neg (x \in C)\\
                &\only<0-3>{\implies}\only<4->{\text{\alert<4>{$\iff$}}} (x \in A \wedge \neg (x \in B)) \wedge (x \in A \wedge \neg (x \in C))\\
                &\only<0-2>{\implies}\only<3->{\text{\alert<3>{$\iff$}}} (x \in A \setminus B) \wedge (x \in A \setminus C)\\
                &\only<0-1>{\implies}\only<2->{\text{\alert<2>{$\iff$}}} x \in (A \setminus B) \cap (A \setminus C)
            \end{align*}\qed
            }
        \\
