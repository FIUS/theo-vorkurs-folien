...
\end{figure}
\section*{\LARGE Feedback - Vorkurs Theoretische Informatik 2025}
\vspace{1cm}

\begin{tabular}{p{5.6cm}p{1.8cm}p{1.8cm}p{2.3cm}p{1.8cm}p{1.8cm}p{0.001cm}}
  Ich war überwiegend in Hörsaal... & $\Box$ 38.01 & $\Box$ 38.02 & $\Box$ 38.04
\end{tabular}

\question*{Warst du an manchen Tagen noch in anderen Räumen, wenn ja wann in welchen?}
...
\begin{tabular}{p{9.5cm}C{2.1cm}C{2.1cm}p{0.001cm}}
   & ja & nein                                       \\
  Ich war auch im Mathe-Vorkurs des MINT-Kolleg      \\\ (22.09.-02.10.) & $\Box$  & $\Box$ \\
  Ich war auch im Informatik-Vorkurs des MINT-Kolleg \\\ (08.09.-12.09. oder 15.09.-19.09.) &  $\Box$ &  $\Box$\\
\end{tabular}
\\
\begin{tabular}{p{8.5cm}C{2.1cm}C{2.1cm}C{2.1cm}p{0.001cm}}
                                                                             & besser & gleich gut & schlechter \\
  Ich fand die Erklärungen der gleichen Themen ... als im MINT-Mathe-Vorkurs & $\Box$ & $\Box$     & $\Box$
\end{tabular}
...
\vertikalblockfour{vollständig}{eher ja}{eher nein}{gar nicht}{
  \blocktextfour{Mengen}
  \blocktextfour{Aussagenlogik}
  \blocktextfour{Beweistechniken}
  \blocktextfour{Prädikatenlogik}
  \blocktextfour{Modulare Arithmetik}
}
